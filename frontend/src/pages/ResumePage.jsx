        ...
        try {
          ...
          setPhase(
            ...
            if (
              ...
              setError(
                "We're unable to analyze your resume right now. Please try again in a few moments."
              );
            }
          } finally {
          setAnalyzing(false);
    ...
    if (error) {
      return (
        <div className="flex min-h-[70vh] items-center justify-center p-6">
          <div className="w-full max-w-lg rounded-2xl border border-orange-200 bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-3 text-[#64748b]">
              Our AI analyzer is currently experiencing high demand.
